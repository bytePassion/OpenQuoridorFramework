...
namespace OQF.Tools.Utils
{
	public static class GeometryLibUtils
    {
		...
		public const byte StandardOutputPrecision   = 6;
	    ...
	    {
		    return DoubleEquals(d1, d2, DoubleEqualityPrecision);
	    }
        ...
        {
            return DoubleFormat(d, StandardOutputPrecision);
        }
