...
namespace OQF.PlayerVsBot.Global
{
	internal static class Constants
	{
		...
		public static readonly SolidColorBrush PossibleMoveFieldColor   = new SolidColorBrush(Color.FromArgb(90, 150, 255, 40));
		public static readonly SolidColorBrush PotentialPlacedWallColor = new SolidColorBrush(Color.FromArgb(207, 255, 255, 255));
		 
		public static readonly Brush TopPlayerActiveColor = new RadialGradientBrush
		{
			...
			GradientStops = new GradientStopCollection
			{
				...
				new GradientStop(Colors.GreenYellow, 1.0)
			}
		};

		public static readonly Brush BottomPlayerActiveColor = new RadialGradientBrush
		{
			Center = new Point(0.5, 0.5),
			GradientOrigin = new Point(0.5, 0.5),
			GradientStops = new GradientStopCollection
