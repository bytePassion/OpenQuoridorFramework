...
namespace WpfLib.ConverterBase
{
	public abstract class GenericFiveToOneValueConverter<TFrom1, TFrom2, TFrom3, TFrom4, TFrom5, TTo> : IMultiValueConverter
	{
		protected virtual TTo Convert(TFrom1 value1, TFrom2 value2, TFrom3 value3, TFrom4 from4, TFrom5 from5, CultureInfo culture)
		{
			throw new NotImplementedException();
		}

		protected virtual Tuple<TFrom1, TFrom2, TFrom3, TFrom4, TFrom5> ConvertBack(TTo value, CultureInfo culture)
		{
			throw new NotImplementedException();
		}
		...
		public object Convert (object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			...
			if (values[4] != null)
				if (values[4].GetType() != typeof(TFrom5))
					if (!(values[4] is TFrom5))
						throw new ArgumentException("types are not matching: cannot convert from " + values[4].GetType() + " to " + typeof(TFrom5));

			return Convert((TFrom1)values[0], (TFrom2)values[1], (TFrom3)values[2], (TFrom4)values[3], (TFrom5)values[4], culture);			
		}
