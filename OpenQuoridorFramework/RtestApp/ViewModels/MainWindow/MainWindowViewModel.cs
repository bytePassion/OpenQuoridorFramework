...
//		}
        ...
        public string BrowseFileButtonCaption    => "blubb" ; //Captions.RV_BrowseFileButtonCaption;
        public string InputPromtLabelCaption     => "blubb" ; //Captions.RV_InputPromtLabelCaption;
        public string LoadAndStartButtonCaption  => "blubb" ; //Captions.RV_LoadAndStartButtonCaption;
        public string NextStepButtonCaption      => "blubb" ; //Captions.RV_NextStepButtonCaption;
        public string PrevStepButtonCaption      => "blubb" ; //Captions.RV_PrevStepButtonCaption;
        public string ProgressSectionHeader      => "blubb" ; //Captions.RV_ProgressSectionHeader;
        public string ShowAboutHelpButtonCaption => "blubb" ; //Captions.RV_ShowAboutHelpButtonCaption;
